...
📖 **[shadi0077.github.io/desktop-buddies](https://shadi0077.github.io/desktop-buddies/desktop-buddies.html)**

The sibling app in this repository is
**[MegaDrive Buddies](megadrive-buddies.md)** — the same engine with the
talking taken out and thirty-seven Mega Drive sprites in place of the cartoons.
...
> are not mine to license — see [SPRITES.md](SPRITES.md). Rights
...
![Arabic speech balloons](img/arabic.png)
