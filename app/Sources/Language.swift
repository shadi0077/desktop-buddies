...
enum UI {
    ...
    private static let arabic: [String: String] = [
        ...
        "About body": """
            بيدي ببغاء، وبونزي غوريلا. يتجولان على سطح مكتبك، ويقدّمان بعض \
            الفقرات، ويتجادلان أحيانًا. اختر واحدًا منهما أو كليهما.

            لا يتصل أي منهما بالإنترنت، ولا يجمع أي بيانات، ولا يغيّر متصفحك، \
            وليس لديه ما يبيعه لك. لهما مستوى صوت خاص بهما، مستقل عن صوت \
            النظام — ويمكنك كتمهما أو إنهاؤهما من هذه القائمة في أي وقت.
